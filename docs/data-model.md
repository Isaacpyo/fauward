# Fauward — Data Model (Complete Schema)

> The authoritative source for all database tables. The Prisma schema at `apps/backend/prisma/schema.prisma` is the live implementation of these definitions — all 35 models are present there. Use this document for human-readable reference.
