...
function DashboardOverviewShimmer() {
  return (
    <>
...
export function DashboardOverviewSections() {
  return (
    <>
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <MetricCard title="Total MRR" value="GBP 114,300" trend="up 8.2% vs last month" trendUp />
        ...
        <MetricCard title="New Signups (7d)" value="31" trend="up 18.4% conversion" trendUp />
      </section>
