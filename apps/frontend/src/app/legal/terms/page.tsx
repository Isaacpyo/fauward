  ...
  return (
    <>
      ...
      <div className="marketing-container max-w-3xl">
        ...
        <MaskRevealHeading className="text-3xl font-bold text-gray-900 md:text-4xl">Terms of Service</MaskRevealHeading>
        ...
        <div className="mt-10 space-y-10 text-sm leading-relaxed text-gray-700">
          ...
          <div>
            <MaskRevealHeading as="h2" className="mb-3 text-xl font-bold text-gray-900">1. The service</MaskRevealHeading>
          ...
          <div>
            <MaskRevealHeading as="h2" className="mb-3 text-xl font-bold text-gray-900">2. Account registration</MaskRevealHeading>
          ...
          <div>
            <MaskRevealHeading as="h2" className="mb-3 text-xl font-bold text-gray-900">3. Subscriptions and billing</MaskRevealHeading>
          ...
          <div>
            <MaskRevealHeading as="h2" className="mb-3 text-xl font-bold text-gray-900">4. Plan limits</MaskRevealHeading>
          ...
          <div>
            <MaskRevealHeading as="h2" className="mb-3 text-xl font-bold text-gray-900">5. Acceptable use</MaskRevealHeading>
          ...
          <div>
            <MaskRevealHeading as="h2" className="mb-3 text-xl font-bold text-gray-900">6. Your data</MaskRevealHeading>
          ...
          <div>
            <MaskRevealHeading as="h2" className="mb-3 text-xl font-bold text-gray-900">7. Intellectual property</MaskRevealHeading>
          ...
          <div>
            <MaskRevealHeading as="h2" className="mb-3 text-xl font-bold text-gray-900">8. Uptime and service levels</MaskRevealHeading>
          ...
          <div>
            <MaskRevealHeading as="h2" className="mb-3 text-xl font-bold text-gray-900">9. Limitation of liability</MaskRevealHeading>
          ...
          <div>
            <MaskRevealHeading as="h2" className="mb-3 text-xl font-bold text-gray-900">10. Termination</MaskRevealHeading>
          ...
          <div>
            <MaskRevealHeading as="h2" className="mb-3 text-xl font-bold text-gray-900">11. Governing law</MaskRevealHeading>
          ...
          <div>
            <MaskRevealHeading as="h2" className="mb-3 text-xl font-bold text-gray-900">12. Changes</MaskRevealHeading>
