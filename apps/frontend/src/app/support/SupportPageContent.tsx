          ...
          <div className="mx-auto mt-8 max-w-xl">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search for guides, FAQs, or topicsâ€¦"
        ...
        <section id="contact" className="bg-gray-50 py-16 lg:py-20">
          <div className="marketing-container">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-3 text-lg text-gray-600">Our team is available Mondayâ€“Friday, 8amâ€“6pm GMT. Enterprise customers get 24/7 dedicated support.</p>
            </div>
